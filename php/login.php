...
<header>
        ...
        <!-- форма авторизации -->
    <section class="auto">
        <form action="sign-in.php" class="login" method="post">
            <h1 class="title-auto">авторизация</h1>
            <input type="text" placeholder="email" class="auto-in" name="email">
            <input type="password" placeholder="пароль" class="auto-in" name="password">
            <div class="g-recaptcha" data-sitekey="6LfigywpAAAAAPop6veRuux8O7_v6xPcdyvsnaOr"></div>
            <input type="submit" id="submit" name="submit" class="b-login" value="войти в аккаунт">
            <a href="reg.php" class="a-in">нет аккаунта</a>
            <?php
                    if ($_SESSION['message']){
