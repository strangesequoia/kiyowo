<?php
    include "db.php";
    $result = mysqli_query($conn,"SELECT * FROM `actions`");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    while($news = mysqli_fetch_assoc($result))
        {
            ...
            <section class="actions">
                    ...
                    <img src=" <?php echo $news['Illustration_action'];?>" alt="" class="action-img">
                    <div class="action-text">
                        <h1 class="action-title"> <?php echo $news['Title_action']; ?></h1>
                        <p class="action-descr"> <?php echo $news['Descr_action']; ?></p>
                    </div>
            </section>
    <?php
        }
