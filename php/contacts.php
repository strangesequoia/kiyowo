...
<header>
    ...
    <section class="contacts">
        <h1 class="con-title">контакты</h1>
        <div class="uls-con">
            <ul class="con-info">
                <li class="con-li">
                    <p class="con-t">kiyowo@gmail.ru</p>
                </li>
                <li class="con-li">
                    <p class="con-t">kiyowo_buisness@gmail.ru</p>
                </li>
                <li class="con-li">
                    <p class="con-t">+7(495)711-46-58</p>
                </li>
            </ul>
            <ul class="con-info">
                 <li class="con-li">
                    <p class="con-t">москва, ул. ак. глушко д. 14</p>
                </li>
                <li class="con-li">
                    <p class="con-t">москва, ул. ак. глушко 6-197</p>
                </li>
            </ul>
        </div>
